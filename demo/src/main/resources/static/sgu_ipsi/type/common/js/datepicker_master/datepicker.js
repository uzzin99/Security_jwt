...
var datePickerController = (function datePickerController() {
    ...
    var localeDefaults = {
        ...
        monthAbbrs:["01","02","03","04","05","06","07","08","09","10","11","12"],
        fullDays:  ["월요일","화요일","수요일","목요일","금요일","토요일","일요일"],
        dayAbbrs:  ["월","화","수","목","금","토","일"],
        titles:    ["이전 달","다음 달","이전 년","다음 년", "오늘", "캘린더 보기", "wk", "Week [[%0%]] of [[%1%]]", "Week", "Select a date", "Click \u0026 Drag to move", "Display \u201C[[%0%]]\u201D first", "Go to Today\u2019s date", "Disabled date :"],
        rtl:       false,
        firstDayOfWeek:0,
        imported:  false
    };
